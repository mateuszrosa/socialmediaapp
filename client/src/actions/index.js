...
export const register = (login, password, email) => (dispatch) => {
  ...
  return axios
    .post(`https://socialmediaapp.fly.dev/user/register/?`, {
      login,
      password,
      email,
      friends: [],
...
export const login = (login, password) => (dispatch) => {
  ...
  return axios
    .get(`https://socialmediaapp.fly.dev/user/login/?${params}`)
    .then((payload) => {
...
export const fetchUsers = () => dispatch => {
  ...
  return axios
    .get(`https://socialmediaapp.fly.dev/users`)
    .then(payload => {
...
export const fetchUserProfile = userId => dispatch => {
  ...
  return axios
    .get(`https://socialmediaapp.fly.dev/user/?${params}`)
    .then(payload => {
...
export const addToFriends = (userId, friendId) => dispatch => {
  ...
  return axios
    .put(`https://socialmediaapp.fly.dev/user/friend/?${params}`)
    .then(payload => {
...
export const removeFromFriends = (userId, friendId) => dispatch => {
  ...
  return axios
    .put(`https://socialmediaapp.fly.dev/user/friend/remove/?${params}`)
    .then(payload => {
...
export const sendMessage = (senderId, senderName, text, to) => dispatch => {
  ...
  return axios
    .post(`https://socialmediaapp.fly.dev/messages/?${params}`)
    .then(payload => {
...
export const deleteMessage = (id, user, box) => dispatch => {
  ...
  return axios
    .delete(`https://socialmediaapp.fly.dev/messages/?${params}`)
    .then(payload => {
...
export const fetchPosts = () => (dispatch) => {
  ...
  return axios
    .get(`https://socialmediaapp.fly.dev/posts`)
    .then((payload) => {
...
export const fetchPost = id => dispatch => {
  ...
  return axios
    .get(`https://socialmediaapp.fly.dev/post/?${params}`)
    .then((payload) => {
...
export const addPost = (text) => (dispatch, getState) => {
  ...
  return axios
    .post(`https://socialmediaapp.fly.dev/post/?`, {
...
export const addLikes = (id, userId) => dispatch => {
  ...
  return axios
    .put(`https://socialmediaapp.fly.dev/post/like/?${params}`)
    .then((payload) => {
...
export const editPost = (id, text) => dispatch => {
  ...
  return axios
    .put(`https://socialmediaapp.fly.dev/post/edit/?${params}`)
    .then(payload => {
...
export const removePost = (id) => dispatch => {
  ...
  return axios
    .delete(`https://socialmediaapp.fly.dev/post/?${params}`)
    .then((payload) => {
...
export const addComment = (text, id, userId, login) => dispatch => {
  ...
  return axios
    .put(`https://socialmediaapp.fly.dev/post/comment/?${params}`)
    .then(payload => {
...
export const removeComment = (id, commentId) => dispatch => {
  ...
  return axios
    .delete(`https://socialmediaapp.fly.dev/post/comment/delete/?${params}`)
    .then(payload => {
...
export const editComment = (id, commentId, text) => dispatch => {
  ...
  return axios
    .put(`https://socialmediaapp.fly.dev/post/comment/edit/?${params}`)
    .then(payload => {
...
export const fetchUsersPosts = userId => dispatch => {
  ...
  return axios
    .get(`https://socialmediaapp.fly.dev/posts/user/?${params}`)
    .then(payload => {
