...
export const register = (login, password, email) => (dispatch) => {
  ...
  return axios
    .post(`http://socialmediaapp-backend.herokuapp.com/user/register/?`, {
      login,
      password,
      email,
      friends: [],
...
export const login = (login, password) => (dispatch) => {
  ...
  return axios
    .get(`http://socialmediaapp-backend.herokuapp.com/user/login/?${params}`)
    .then((payload) => {
...
export const fetchUsers = () => dispatch => {
  ...
  return axios
    .get(`http://socialmediaapp-backend.herokuapp.com/users`)
    .then(payload => {
...
export const fetchUserProfile = userId => dispatch => {
  ...
  return axios
    .get(`http://socialmediaapp-backend.herokuapp.com/user/?${params}`)
    .then(payload => {
...
export const addToFriends = (userId, friendId) => dispatch => {
  ...
  return axios
    .put(`http://socialmediaapp-backend.herokuapp.com/user/friend/?${params}`)
    .then(payload => {
...
export const removeFromFriends = (userId, friendId) => dispatch => {
  ...
  return axios
    .put(`http://socialmediaapp-backend.herokuapp.com/user/friend/remove/?${params}`)
    .then(payload => {
...
export const sendMessage = (senderId, senderName, text, to) => dispatch => {
  ...
  return axios
    .post(`http://socialmediaapp-backend.herokuapp.com/messages/?${params}`)
    .then(payload => {
...
export const deleteMessage = (id, user, box) => dispatch => {
  ...
  return axios
    .delete(`http://socialmediaapp-backend.herokuapp.com/messages/?${params}`)
    .then(payload => {
...
export const fetchPosts = () => (dispatch) => {
  ...
  return axios
    .get(`http://socialmediaapp-backend.herokuapp.com/posts`)
    .then((payload) => {
...
export const fetchPost = id => dispatch => {
  ...
  return axios
    .get(`http://socialmediaapp-backend.herokuapp.com/post/?${params}`)
    .then((payload) => {
...
export const addPost = (text) => (dispatch, getState) => {
  ...
  return axios
    .post(`http://socialmediaapp-backend.herokuapp.com/post/?`, {
...
export const addLikes = (id, userId) => dispatch => {
  ...
  return axios
    .put(`http://socialmediaapp-backend.herokuapp.com/post/like/?${params}`)
    .then((payload) => {
...
export const editPost = (id, text) => dispatch => {
  ...
  return axios
    .put(`http://socialmediaapp-backend.herokuapp.com/post/edit/?${params}`)
    .then(payload => {
...
export const removePost = (id) => dispatch => {
  ...
  return axios
    .delete(`http://socialmediaapp-backend.herokuapp.com/post/?${params}`)
    .then((payload) => {
...
export const addComment = (text, id, userId, login) => dispatch => {
  ...
  return axios
    .put(`http://socialmediaapp-backend.herokuapp.com/post/comment/?${params}`)
    .then(payload => {
...
export const removeComment = (id, commentId) => dispatch => {
  ...
  return axios
    .delete(`http://socialmediaapp-backend.herokuapp.com/post/comment/delete/?${params}`)
    .then(payload => {
...
export const editComment = (id, commentId, text) => dispatch => {
  ...
  return axios
    .put(`http://socialmediaapp-backend.herokuapp.com/post/comment/edit/?${params}`)
    .then(payload => {
...
export const fetchUsersPosts = userId => dispatch => {
  ...
  return axios
    .get(`http://socialmediaapp-backend.herokuapp.com/posts/user/?${params}`)
    .then(payload => {
